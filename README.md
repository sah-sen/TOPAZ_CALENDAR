...
6. Using the same Find and replace in whole project folder search for `TOPAZ` (display name, launcher name) and replace it with your own suitable name for your app
